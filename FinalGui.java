...
public class FinalGui extends Frame {
...
playButton.setBounds(400,300,95,30);  
		...
		if(sequence) {
			...
			JLabel keyText[] = new JLabel[broi[1]];//creates the text for each key
			JLabel	playingPosition=new JLabel();//creates the sign that shows which second is playing
